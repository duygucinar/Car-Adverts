 ...
 * @author uset
 */
public class renk_listeleme extends javax.swing.JFrame {

    Object satirlar[]= new Object[2];
    public renk_listeleme() throws SQLException {
        this.setResizable(false);
        this.setLocation(450, 200);
        this.setTitle("RENK LİSTELEME");
    ...
    public void myInitComponents() throws SQLException{
        ...
        bg.myRs = bg.myStat.executeQuery("select * from renkler order by renk_id");
        
        while(bg.myRs.next()){
            satirlar[0]=bg.myRs.getString("renk_id");
            satirlar[1]=bg.myRs.getString("renk");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(cikis, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(renk_listeleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new renk_listeleme().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(renk_listeleme.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
