 ...
 * @author uset
 */
public class sehir_guncelleme extends javax.swing.JFrame {

    /**
     * Creates new form sehir_guncelleme
     */
    public sehir_guncelleme() {
        this.setResizable(false);
        this.setLocation(750, 450);
        this.setTitle("ŞEHİR GÜNCELLEME");
        ...
        try {
            ...
            while(bg.myRs.next()){
                if(bg.myRs.getString("sehir_id").equalsIgnoreCase(ID)){
                    ...
                    if(kontrol2){
                        bg.myStat.executeUpdate("update sehirler set sehir='"+sehir+"' where sehir_id='"+ID+"'");
                        JOptionPane.showMessageDialog(null,"'"+ID+"' ID numaralı şehir güncellendi");
                    }
                    else
            ...
            if(!kontrol){
                JOptionPane.showMessageDialog(null,"'"+ID+"' ID numaralı sehir bulunmamaktadır");
            }
            bg.myRs.close();
            bg.myStat.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sehir_guncelleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sehir_guncelleme().setVisible(true);
            }
        });
    }
