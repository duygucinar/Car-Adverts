 ...
 * @author uset
 */
public class sehir_listeleme extends javax.swing.JFrame {

    Object satirlar[]= new Object[2];
    public sehir_listeleme() throws SQLException {
        this.setResizable(false);
        this.setLocation(450, 200);
        this.setTitle("ŞEHİR LİSTELEME");
    ...
    public void myInitComponents() throws SQLException{
        ...
        bg.myRs = bg.myStat.executeQuery("select * from sehirler order by sehir_id");
        
        while(bg.myRs.next()){
            satirlar[0]=bg.myRs.getString("sehir_id");
            satirlar[1]=bg.myRs.getString("sehir");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cikis, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sehir_listeleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new sehir_listeleme().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(sehir_listeleme.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
