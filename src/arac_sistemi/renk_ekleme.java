 ...
 * @author uset
 */
public class renk_ekleme extends javax.swing.JFrame {

    /**
     * Creates new form renk_ekleme
     */
    public renk_ekleme() {
        this.setResizable(false);
        this.setLocation(750, 450);
        this.setTitle("RENK EKLEME");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(rengi, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(134, 134, 134)
                        .addComponent(ekle))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleActionPerformed
        ...
        try {
            bg.myRs = bg.myStat.executeQuery("select * from renkler");
                ...
                if(kontrol2==true){
                    bg.myStat.executeUpdate("insert into renkler (renk) value('"+renk+"')");
                    JOptionPane.showMessageDialog(null,"Renk oluşturuldu !");
                }
                else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(renk_ekleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new renk_ekleme().setVisible(true);
            }
        });
    }
