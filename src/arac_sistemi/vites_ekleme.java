 ...
 * @author uset
 */
public class vites_ekleme extends javax.swing.JFrame {

    /**
     * Creates new form vites_ekleme
     */
    public vites_ekleme() {
        this.setResizable(false);
        this.setLocation(750, 450);
        this.setTitle("VİTES TÜRÜ EKLEME");
    ...
    private void ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleActionPerformed
        ...
        try {
            ...
            if(kontrol2==true){
                bg.myStat.executeUpdate("insert into vites (vites_turu) value('"+vites+"')");
                JOptionPane.showMessageDialog(null,"Vites Türü oluşturuldu");
            }
            else
                JOptionPane.showMessageDialog(null,"'"+vites+"' Vites Türü bulunmaktadır");
        } catch (SQLException ex) {
            Logger.getLogger(vites_ekleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vites_ekleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vites_ekleme().setVisible(true);
            }
        });
    }
