 ...
 * @author uset
 */
public class veri_listeleme extends javax.swing.JFrame {

    /**
     * Creates new form veri_listeleme
     */
    public veri_listeleme() {
        this.setResizable(false);
        this.setLocation(750, 450);
        this.setTitle("VERİ LİSTELEME");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Veri listelemek istediğiniz alanı seçiniz");
    ...
    private void ilanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ilanActionPerformed
        try {
            ...
            Logger.getLogger(veri_listeleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void arabaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_arabaActionPerformed
        this.setVisible(false);
        try {
            arac_listeleme frame = new arac_listeleme();
        } catch (SQLException ex) {
            Logger.getLogger(veri_listeleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void renkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_renkActionPerformed
        this.setVisible(false);
        try {
            renk_listeleme frame = new renk_listeleme();
        } catch (SQLException ex) {
            Logger.getLogger(veri_listeleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void vites_turuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_vites_turuActionPerformed
        this.setVisible(false);
        try {
            vites_listeleme frame = new vites_listeleme();
        } catch (SQLException ex) {
            Logger.getLogger(veri_listeleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void yakit_turuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yakit_turuActionPerformed
        this.setVisible(false);
        try {
            yakit_listeleme frame = new yakit_listeleme();
        } catch (SQLException ex) {
            Logger.getLogger(veri_listeleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void sehirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sehirActionPerformed
        this.setVisible(false);
        try {
            sehir_listeleme frame = new sehir_listeleme();
        } catch (SQLException ex) {
            Logger.getLogger(veri_listeleme.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(veri_listeleme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new veri_listeleme().setVisible(true);
            }
        });
    }
